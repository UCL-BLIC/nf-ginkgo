...
regexes = {
    'nf-core/wgsalign': ['v_ngi_chipseq.txt', r"(\S+)"],
...
results = OrderedDict()
results['nf-core/wgsalign'] = '<span style="color:#999999;\">N/A</span>'
...
# Dump to YAML
print ('''
id: 'nf-core/wgsalign-software-versions'
section_name: 'nf-core/wgsalign Software Versions'
