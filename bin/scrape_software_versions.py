...
regexes = {
    'nf-core/ginkgo': ['v_ngi_chipseq.txt', r"(\S+)"],
...
results = OrderedDict()
results['nf-core/ginkgo'] = '<span style="color:#999999;\">N/A</span>'
...
# Dump to YAML
print ('''
id: 'nf-core/ginkgo-software-versions'
section_name: 'nf-core/ginkgo Software Versions'
